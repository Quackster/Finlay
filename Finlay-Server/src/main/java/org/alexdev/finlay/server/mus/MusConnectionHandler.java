package org.alexdev.finlay.server.mus;
...
import org.alexdev.finlay.dao.mysql.PhotoDao;
...
import org.alexdev.finlay.game.item.Photo;
...
import org.alexdev.finlay.server.mus.connection.MusClient;
import org.alexdev.finlay.server.mus.streams.MusMessage;
import org.alexdev.finlay.server.mus.streams.MusPropList;
import org.alexdev.finlay.server.mus.streams.MusTypes;
...
public class MusConnectionHandler extends SimpleChannelInboundHandler<MusMessage> {
    ...
    public void channelRegistered(ChannelHandlerContext ctx) {
        if (!this.server.getChannels().add(ctx.channel()) || Finlay.isShuttingdown()) {
    ...
    public void channelRead0(ChannelHandlerContext ctx, MusMessage message) {
        ...
        try {
            ...
            if (message.getSubject().equals("Logon")) {
                ...
                reply.setContentString("Finlay: Habbo Hotel shockwave emulator");
