package org.alexdev.finlay.messages;

import org.alexdev.finlay.game.player.Player;
import org.alexdev.finlay.game.room.RoomManager;
import org.alexdev.finlay.log.Log;
import org.alexdev.finlay.messages.incoming.catalogue.GCAP;
import org.alexdev.finlay.messages.incoming.catalogue.GCIX;
import org.alexdev.finlay.messages.incoming.catalogue.GET_ALIAS_LIST;
import org.alexdev.finlay.messages.incoming.catalogue.GRPC;
import org.alexdev.finlay.messages.incoming.club.GET_CLUB;
import org.alexdev.finlay.messages.incoming.club.SCR_GIFT_APPROVAL;
...
import org.alexdev.finlay.messages.incoming.inventory.GETSTRIP;
import org.alexdev.finlay.messages.incoming.jukebox.*;
import org.alexdev.finlay.messages.incoming.messenger.*;
import org.alexdev.finlay.messages.incoming.moderation.*;
import org.alexdev.finlay.messages.incoming.navigator.*;
import org.alexdev.finlay.messages.incoming.purse.GETUSERCREDITLOG;
import org.alexdev.finlay.messages.incoming.purse.REDEEM_VOUCHER;
import org.alexdev.finlay.messages.incoming.recycler.CONFIRM_FURNI_RECYCLING;
import org.alexdev.finlay.messages.incoming.recycler.START_FURNI_RECYCLING;
import org.alexdev.finlay.messages.incoming.recycler.GET_FURNI_RECYCLER_CONFIGURATION;
import org.alexdev.finlay.messages.incoming.recycler.GET_FURNI_RECYCLER_STATUS;
import org.alexdev.finlay.messages.incoming.register.*;
import org.alexdev.finlay.messages.incoming.rooms.*;
import org.alexdev.finlay.messages.incoming.rooms.badges.GETAVAILABLEBADGES;
import org.alexdev.finlay.messages.incoming.rooms.badges.SETBADGE;
import org.alexdev.finlay.messages.incoming.rooms.dimmer.MSG_ROOMDIMMER_CHANGE_STATE;
import org.alexdev.finlay.messages.incoming.rooms.dimmer.MSG_ROOMDIMMER_GET_PRESETS;
import org.alexdev.finlay.messages.incoming.rooms.dimmer.MSG_ROOMDIMMER_SET_PRESET;
import org.alexdev.finlay.messages.incoming.rooms.items.*;
...
import org.alexdev.finlay.messages.incoming.tutorial.GET_TUTORIAL_CONFIGURATION;
import org.alexdev.finlay.messages.incoming.tutorial.SET_TUTORIAL_MODE;
import org.alexdev.finlay.messages.incoming.user.*;
import org.alexdev.finlay.messages.incoming.user.settings.GET_ACCOUNT_PREFERENCES;
import org.alexdev.finlay.messages.incoming.user.settings.GET_SOUND_SETTING;
import org.alexdev.finlay.messages.incoming.user.settings.UPDATE_ACCOUNT;
import org.alexdev.finlay.messages.incoming.welcomingparty.ACCEPT_TUTOR_INVITATION;
import org.alexdev.finlay.messages.incoming.welcomingparty.REJECT_TUTOR_INVITATION;
import org.alexdev.finlay.messages.incoming.wobblesquabble.PTM;
